...
namespace CMS.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Result,Justification")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Result,Justification")] Review review)
        {
            if (ModelState.IsValid)
            {
